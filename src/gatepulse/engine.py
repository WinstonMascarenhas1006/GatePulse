...
PIPELINE_STAGES = [
    {
        ...
        "title": "1 · Generate",
        "layer": "BACKEND",
        "blurb": "Synthetic campus programmes, gates, tasks (source of truth for demo).",
        "writes": "data/raw/*.csv",
    },
    {
        "id": "etl",
        "title": "2 · ETL",
        "layer": "BACKEND",
        "blurb": "Clean invalid dates/statuses, build programme facts, load SQLite.",
    ...
    },
    {
        ...
        "layer": "BACKEND",
        "blurb": "Score completeness/validity; per-programme quality index.",
    ...
    },
    {
        ...
        "title": "4 · AI risk",
        "layer": "BACKEND",
        "blurb": "Train RandomForest deadline-slip risk; export scores + feature importance.",
